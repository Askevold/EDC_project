...
def hent_data(first):
    ...
    """
    class_1 =open("Iris_TTT4275/class_1").read().split('\n')
    class_2= open("Iris_TTT4275/class_2").read().split('\n')
    class_3 = open("Iris_TTT4275/class_3").read().split('\n')
...
def trening(alpha, iterations, L ,LK, feature_nr):
    """
    Trene del: tar inn steps alpha, antall iterationer, Lære matrise, sanne klassene til lærematrisen og antall featuers som er benyttet.
    ...
    for i in range(iterations):
        ...
        line = ('\n Iteration: '+str(i)+' MSE: '+str(MSE(LK, g).mean()))
        f.write(line)
